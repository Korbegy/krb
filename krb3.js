          ...
          async function getnationsfixture() {
            ...
            for (const event of events) {
                if (event.status.type.description !== "Postponed"){
                  ...
                  console.log(league);
            const nations_URL = `https://f20.us/p/live.html#${Slug}/${eventId}`;
            ...
            async function getpremierleaguefixture() {
              ...
              for (const event of events) {
                  if (event.status.type.description !== "Postponed"){
                    ...
                    const awayteamscore = event.competitions[0].competitors[1].score;
                    console.log(league);
              const premierleague_URL = `https://f20.us/p/premierleague.html#${Slug}/${eventId}`;
              if (event.status.type.state === "pre"){
            ...
            async function getWeek15Games() {
              ...
              for (const event of events) {
                if (event.status.type.description !== "Final") {
                    ...
                    const M_URL = `https://f20.us/p/nfl.html#${homeTeam.team.shortDisplayName} vs ${awayTeam.team.shortDisplayName}`; 
             ...
             async function getfifafriendlyfixture() {
               ...
               for (const event of events) {
                   if (event.status.type.description !== "Postponed"){
                     ...
                     const awayteamscore = event.competitions[0].competitors[1].score;
                     console.log(league);
               const fifafriendly_URL = `https://f20.us/p/live.html#${Slug}/${eventId}`;
               if (event.status.type.state === "pre"){
             ...
             async function getmlsfixture() {
               ...
               for (const event of events) {
                   if (event.status.type.description !== "Postponed"){
                     ...
                     const awayteamscore = event.competitions[0].competitors[1].score;
                     console.log(league);
               const mls_URL = `https://f20.us/p/live.html#${Slug}/${eventId}`;
               if (event.status.type.state === "pre"){
             ...
             async function getitafixture() {
               ...
               for (const event of events) {
                   if (event.status.type.description !== "Postponed"){
                     ...
                     const awayteamscore = event.competitions[0].competitors[1].score;
                     console.log(league);
               const ita_URL = `https://f20.us/p/seriaA.html#${Slug}/${eventId}`;
               if (event.status.type.state === "pre"){
             ...
             async function getesfixture() {
               ...
               for (const event of events) {
                   if (event.status.type.description !== "Postponed"){
                     ...
                     const awayteamscore = event.competitions[0].competitors[1].score;
                     console.log(league);
               const es_URL = `https://f20.us/p/laliga.html#${Slug}/${eventId}`;
               if (event.status.type.state === "pre"){
              ...
              async function getbundesligafixture() {
                ...
                for (const event of events) {
                    if (event.status.type.description !== "Postponed"){
                      ...
                      const awayteamscore = event.competitions[0].competitors[1].score;
                      console.log(league);
                const de_URL = `https://f20.us/p/bundesliga.html#${Slug}/${eventId}`;
                if (event.status.type.state === "pre"){
 ...
 async function getchampionsleaguefixture() {
   ...
   for (const event of events) {
       if (event.status.type.description !== "Postponed"){
         ...
         const awayteamscore = event.competitions[0].competitors[1].score;
         console.log(league);
   const championsleague_URL = `https://f20.us/p/championsleague.html#${Slug}/${eventId}`;
   if (event.status.type.state === "pre"){
...
async function geteuroqualificationfixture() {
  ...
  for (const event of events) {
      if (event.status.type.description !== "Postponed"){
        ...
        const awayteamscore = event.competitions[0].competitors[1].score;
        console.log(league);
  const euro_URL = `https://f20.us/p/live.html#${Slug}/${eventId}`;
  if (event.status.type.state === "pre"){
...
async function getksafixture() {
  ...
  for (const event of events) {
      if (event.status.type.description !== "Postponed"){
        ...
        const awayteamscore = event.competitions[0].competitors[1].score;
        console.log(league);
  const ksa_URL = `https://f20.us/p/live.html#${Slug}/${eventId}`;
  if (event.status.type.state === "pre"){
...
async function geteuropafixture() {
  ...
  for (const event of events) {
      if (event.status.type.description !== "Postponed"){
        ...
        const awayteamscore = event.competitions[0].competitors[1].score;
        console.log(league);
  const europa_URL = `https://f20.us/p/europaleague.html#${Slug}/${eventId}`;
  if (event.status.type.state === "pre"){
    ...
    for (const event of events) {
      ...
      const circuitfullname = event.circuit.fullName;
        ...
        for (const competition of competitions) {
          ...
          const formula_URL = `https://f20.us/p/formula1.html#${nameofevent}`;
