          ...
          async function getnationsfixture() {
            ...
            for (const event of events) {
                if (event.status.type.description !== "Postponed"){
                  ...
                  console.log(league);
            const nations_URL = `https://live.krbgy.xyz/#${Slug}/${eventId}`;
            ...
            async function getpremierleaguefixture() {
              ...
              for (const event of events) {
                  if (event.status.type.description !== "Postponed"){
                    ...
                    const awayteamscore = event.competitions[0].competitors[1].score;
                    console.log(league);
              const premierleague_URL = `https://premierleague.krbgy.xyz/#${Slug}/${eventId}`;
              if (event.status.type.state === "pre"){
             ...
             async function getfifafriendlyfixture() {
               ...
               for (const event of events) {
                   if (event.status.type.description !== "Postponed"){
                     ...
                     const awayteamscore = event.competitions[0].competitors[1].score;
                     console.log(league);
               const fifafriendly_URL = `https://live.krbgy.xyz/#${Slug}/${eventId}`;
               if (event.status.type.state === "pre"){
             ...
             async function getmlsfixture() {
               ...
               for (const event of events) {
                   if (event.status.type.description !== "Postponed"){
                     ...
                     const awayteamscore = event.competitions[0].competitors[1].score;
                     console.log(league);
               const mls_URL = `https://live.krbgy.xyz/#${Slug}/${eventId}`;
               if (event.status.type.state === "pre"){
             ...
             async function getitafixture() {
               ...
               for (const event of events) {
                   if (event.status.type.description !== "Postponed"){
                     ...
                     const awayteamscore = event.competitions[0].competitors[1].score;
                     console.log(league);
               const ita_URL = `https://live.krbgy.xyz/#${Slug}/${eventId}`;
               if (event.status.type.state === "pre"){
             ...
             async function getesfixture() {
               ...
               for (const event of events) {
                   if (event.status.type.description !== "Postponed"){
                     ...
                     const awayteamscore = event.competitions[0].competitors[1].score;
                     console.log(league);
               const es_URL = `https://laliga.krbgy.xyz/#${Slug}/${eventId}`;
               if (event.status.type.state === "pre"){
              ...
              async function getbundesligafixture() {
                ...
                for (const event of events) {
                    if (event.status.type.description !== "Postponed"){
                      ...
                      const awayteamscore = event.competitions[0].competitors[1].score;
                      console.log(league);
                const de_URL = `https://live.krbgy.xyz/#${Slug}/${eventId}`;
                if (event.status.type.state === "pre"){
 ...
 async function getchampionsleaguefixture() {
   ...
   for (const event of events) {
       if (event.status.type.description !== "Postponed"){
         ...
         const awayteamscore = event.competitions[0].competitors[1].score;
         console.log(league);
   const championsleague_URL = `https://championsleague.krbgy.xyz/#${Slug}/${eventId}`;
   if (event.status.type.state === "pre"){
...
async function geteuroqualificationfixture() {
  ...
  for (const event of events) {
      if (event.status.type.description !== "Postponed"){
        ...
        const awayteamscore = event.competitions[0].competitors[1].score;
        console.log(league);
  const euro_URL = `https://live.krbgy.xyz/#${Slug}/${eventId}`;
  if (event.status.type.state === "pre"){
...
async function getksafixture() {
  ...
  for (const event of events) {
      if (event.status.type.description !== "Postponed"){
        ...
        const awayteamscore = event.competitions[0].competitors[1].score;
        console.log(league);
  const ksa_URL = `https://live.krbgy.xyz/#${Slug}/${eventId}`;
  if (event.status.type.state === "pre"){
...
async function geteuropafixture() {
  ...
  for (const event of events) {
      if (event.status.type.description !== "Postponed"){
        ...
        const awayteamscore = event.competitions[0].competitors[1].score;
        console.log(league);
  const europa_URL = `https://europaleague.krbgy.xyz/#${Slug}/${eventId}`;
  if (event.status.type.state === "pre"){
    ...
    for (const event of events) {
      ...
      const circuitfullname = event.circuit.fullName;
        ...
        for (const competition of competitions) {
          ...
          const formula_URL = `https://formula1.krbgy.xyz#${nameofevent}`;
...
async function getgoldfixture() {
  ...
  for (const event of events) {
      if (event.status.type.description !== "Postponed"){
        ...
        const awayteamscore = event.competitions[0].competitors[1].score;
        console.log(league);
  const concacafgold_URL = `https://live.krbgy.xyz/#${Slug}/${eventId}`;
  if (event.status.type.state === "pre"){
             ...
             async function getclubfriendlyfixture() {
               ...
               for (const event of events) {
                   if (event.status.type.description !== "Postponed"){
                     ...
                     const awayteamscore = event.competitions[0].competitors[1].score;
                     console.log(league);
               const clubfriendly_URL = `https://live.krbgy.xyz/#${Slug}/${eventId}`;
               if (event.status.type.state === "pre"){
            ...
            async function getWeek15Games() {
              ...
              for (const event of events) {
                if (event.status.type.completed !== true) {
                    ...
                    const M_URL = `https://nfl.krbgy.xyz/#football/${Slug}/${eventId}`; 
...
async function getNBA() {
  ...
  for (const event of events) {
    if (event.status.type.description !== "Final") {
        ...
        const eventId = event.id;
        const currentTime = new Date();
        const NBA_URL = `https://nba.krbgy.xyz/#basketball/${Slug}/${eventId}`;
 ...
 async function getcarabaofixture() {
   ...
   for (const event of events) {
       if (event.status.type.description !== "Postponed"){
         ...
         const awayteamscore = event.competitions[0].competitors[1].score;
         console.log(league);
   const carabao_URL = `https://live.krbgy.xyz/#${Slug}/${eventId}`;
   if (event.status.type.state === "pre"){
 ...
 async function getfafixture() {
   ...
   for (const event of events) {
       if (event.status.type.description !== "Postponed"){
         ...
         const awayteamscore = event.competitions[0].competitors[1].score;
         console.log(league);
   const fa_URL = `https://live.krbgy.xyz/#${Slug}/${eventId}`;
   if (event.status.type.state === "pre"){
 ...
 async function getmxfixture() {
   ...
   for (const event of events) {
       if (event.status.type.description !== "Postponed"){
         ...
         const awayteamscore = event.competitions[0].competitors[1].score;
         console.log(league);
   const mx_URL = `https://live.krbgy.xyz/#${Slug}/${eventId}`;
   if (event.status.type.state === "pre"){
 ...
 async function getfrafixture() {
   ...
   for (const event of events) {
       if (event.status.type.description !== "Postponed"){
         ...
         const awayteamscore = event.competitions[0].competitors[1].score;
         console.log(league);
   const fra_URL = `https://live.krbgy.xyz/#${Slug}/${eventId}`;
   if (event.status.type.state === "pre"){
 ...
 async function getdelreyfixture() {
   ...
   for (const event of events) {
       if (event.status.type.description !== "Postponed"){
         ...
         const awayteamscore = event.competitions[0].competitors[1].score;
         console.log(league);
   const delrey_URL = `https://live.krbgy.xyz/#${Slug}/${eventId}`;
   if (event.status.type.state === "pre"){
 ...
 async function getmlb() {
   ...
   for (const event of events) {
     if (event.status.type.completed !== true) {
         ...
         const mlb_URL = `https://live.krbgy.xyz/#baseball/${Slug}/${eventId}`; 
